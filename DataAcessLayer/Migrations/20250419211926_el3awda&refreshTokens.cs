...
{
    /// <inheritdoc />
    public partial class el3awdarefreshTokens : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemberShipDate = table.Column<DateTime>(type: "timestamp(6) without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(type: "timestamp(6) without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    LoanDate = table.Column<DateTime>(type: "timestamp(6) without time zone", nullable: false),
                    DueDate = table.Column<DateTime>(type: "timestamp(6) without time zone", nullable: false),
                    ReturnDate = table.Column<DateTime>(type: "timestamp(6) without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssueDate = table.Column<DateTime>(type: "timestamp(6) without time zone", nullable: false),
